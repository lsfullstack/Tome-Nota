...
export class createTables1667820439642 implements MigrationInterface {
    name = 'createTables1667820439642'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lesson" ADD CONSTRAINT "FK_e35de5d5260a5dd79077dfb731a" FOREIGN KEY ("videoId") REFERENCES "video"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
